            ...
            if data_type in ["Hypergraph", "Dual Hypergraph"]:
                ...
                with open(FILE_PATHS[data_type], "r") as f:
                    ...
                    if data_type == "Genes":
                        json_data = json_data[
                            "Genes"
                        ]  # Genes data is nested under "Genes" key
                ...
                if data_type == "Atoms":
                    ...
                    with col2:
                        avg_weight = sum(
                            float(mol["properties"][0]["molecular_weight"])
                            for mol in json_data
                        ) / len(json_data)
                    ...
                    with col2:
                        unique_chromosomes = len(
                            set(
                                g["properties"]["chromosome_location"]
                                for g in json_data
                            )
                        )
                    ...
                    with col3:
                        process_counts = [
                            len(g["properties"]["biological_processes"])
                            for g in json_data
                        ]
                        avg_processes = (
